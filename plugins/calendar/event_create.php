...
function show_event_form()
{
    ...
    echo "      </SELECT>\n" . "      </td></tr>\n" . html_tag('tr') . html_tag('td', _('Title:'), 'right', $color[4]) . "\n" . html_tag('td', '', 'left', $color[4]) . "\n" . "      <INPUT TYPE=text NAME=\"event_title\" VALUE=\"\" SIZE=30 MAXLENGTH=50><BR>\n" . "      </td></tr>\n" . html_tag(
        ...
        html_tag(
            ...
            html_tag(
                 'td',
                 '<INPUT TYPE=SUBMIT NAME=send VALUE="' . _('Set Event') . '">',
                 'left',
                 $color[4],
                 'colspan="2"'
             )
...
echo html_tag('tr', '', '', $color[0]) . html_tag('td', '', 'left') . html_tag('table', '', '', $color[0], 'width="100%" border="0" cellpadding="2" cellspacing="1"') . html_tag(
    'tr',
