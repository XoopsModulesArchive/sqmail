 ...
 *
 * $Id: event_delete.php,v 1.14 2003/01/23 20:43:29 tassium Exp $
 */
define('SM_PATH', '../../');
...
function confirm_deletion()
{
    ...
    echo html_tag(
        ...
        html_tag(
            ...
            'tr',
            html_tag('td', _('Date:'), 'right', $color[4]) . html_tag('td', $dmonth . '/' . $dday . '/' . $dyear, 'left', $color[4])
        ) . html_tag(
            'tr',
            html_tag('td', _('Time:'), 'right', $color[4]) . html_tag('td', $dhour . ':' . $dminute, 'left', $color[4])
        ) . html_tag(
            'tr',
            html_tag('td', _('Title:'), 'right', $color[4]) . html_tag('td', $tmparray['title'], 'left', $color[4])
        ) . html_tag(
            'tr',
            html_tag('td', _('Message:'), 'right', $color[4]) . html_tag('td', $tmparray['message'], 'left', $color[4])
        ) . html_tag(
            'tr',
            html_tag(
                'td',
