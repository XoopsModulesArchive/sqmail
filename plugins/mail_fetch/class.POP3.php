 ...
 * pop3 class
 *
 * $Id: class.POP3.php,v 1.10 2002/12/31 12:49:37 kink Exp $
 */
class POP3
{
    ...
    public function connect($server, $port = 110)
    {
        ...
        $fp = fsockopen((string)$server, $port, $errno, $errstr);
    ...
    public function parse_banner($server_text)
    {
        ...
        $length = mb_strlen($server_text);

        for ($count = 0; $count < $length; $count++) {
            $digit = mb_substr($server_text, $count, 1);
