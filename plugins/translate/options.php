 ...
 *
 * $Id: options.php,v 1.17 2003/02/02 10:07:05 tokul Exp $
 */
...
{
    echo "<li><b>$tit</b> - " . $com . "[ <a href=\"$url\" target=\"_blank\">$tit</a> ]</li>";
}
...
<p>
    ...
    echo '</select>' . '</td></tr>' . '<tr><td align=right nowrap>' . _('When reading:') . '</td>' . '<td><input type=checkbox name="translate_translate_show_read"';
    ...
    echo '> - ' . _('Translate inside the SquirrelMail frames') . '</td></tr>' . '<tr><td align=right nowrap>' . _('When composing:') . '</td>' . '<td><input type=checkbox name="translate_translate_show_send"';
    if ($translate_show_send) {
        echo ' CHECKED';
    }
    echo '> - ' . _('Not yet functional, currently does nothing') . '</td></tr>' . '<tr><td></td><td>' . '<input type="submit" value="' . _('Submit') . '" name="submit_translate">' . '</td></tr>' . '</table>' . '</form>' . "</body></html>\n";
