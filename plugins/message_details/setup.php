 ...
 *
 * $Id: setup.php,v 1.2 2002/09/23 10:07:55 kink Exp $
 **/
...
{
    global $passed_id, $mailbox, $ent_num, $color, $javascript_on;

    if (mb_strlen(trim($mailbox)) < 1) {
        $mailbox = 'INBOX';
    }

    $params = '?passed_ent_id=' . $ent_num . '&mailbox=' . urlencode($mailbox) . '&passed_id=' . $passed_id;
