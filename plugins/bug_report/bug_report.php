 ...
 *
 * $Id: bug_report.php,v 1.11 2002/12/31 12:49:34 kink Exp $
 */
define('SM_PATH', '../../');
...
if ($imap_stream) {
    ...
    fwrite($imap_stream, "a001 CAPABILITY\r\n");
    ...
    fwrite($imap_stream, "a002 LOGOUT\r\n");
...
$body = htmlspecialchars($body_top . $body, ENT_QUOTES | ENT_HTML5);
...
<ul>
    <li>Make sure that you are running the most recent copy of
        ...
        using version <?php echo $version ?>.
    </li>
    <li>Check to see if you bug is already listed in the
        ...
        If it is, we already know about it and are trying to fix it.
    </li>
