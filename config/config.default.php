 ...
 *
 * Don't edit this file directly.  Copy it to config.php before you edit it
 * For sqMail (Xoops) users change simply
 * $domain, $imapServerAddress, $imapPort, $smtpServerAddress, $smtpPort
 */
 ...
 */
global $org_title;
$org_title = "sqMail $config_version";
...
//$imapServerAddress = 'mail.yourdomain.com';
$imapPort = 143;
...
$attachment_dir = (string)$data_dir;
