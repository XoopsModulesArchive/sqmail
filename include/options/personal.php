 ...
 *
 * $Id: personal.php,v 1.8 2003/01/08 14:49:59 tassium Exp $
 */
...
function load_optpage_data_personal()
{
    ...
    if ($tzChangeAllowed) {
        ...
        if ((!is_readable($tzfile)) or (!$fd = fopen($tzfile, 'rb'))) {
