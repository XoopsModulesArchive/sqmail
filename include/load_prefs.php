 ...
 *
 * $Id: load_prefs.php,v 1.12 2003/03/11 17:48:00 kink Exp $
 */
...
if ('' == $left_size) {
    $left_size = $default_left_size ?? 200;
}
...
$left_refresh = mb_strtolower($left_refresh);
...
$show_html_default = getPref($data_dir, $username, 'show_html_default', SMPREF_OFF);

$enable_forward_as_attachment = getPref($data_dir, $username, 'enable_forward_as_attachment', SMPREF_ON);
