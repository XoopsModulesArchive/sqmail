 ...
 *
 * $Id: right_main.php,v 1.104 2003/03/11 17:39:21 kink Exp $
 */
...
if ($composenew) {
    $comp_uri = SM_PATH . 'src/compose.php?mailbox=' . urlencode($mailbox) . "&session=$session";
                ...
                html_tag(
                    ...
                    html_tag(
                        ...
                        html_tag(
                            ...
                            '',
                            $color[4],
                            'width="100%" cellpadding="5" cellspacing="1" border="0"'
                        )
                    )
                ),
                'center',
                $color[9],
                'width="70%" cellpadding="0" cellspacing="3" border="0"'
            );
        }
    }
}
...
if ($use_mailbox_cache && sqisset(\ < ? php
