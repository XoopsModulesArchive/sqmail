 ...
 *
 * $Id: webmail.php,v 1.92 2003/03/11 17:39:25 kink Exp $
 */
if (!isset($xoopsIntro)) {
...
if (isset($languages[$squirrelmail_language]['DIR'])
    && 'rtl' == mb_strtolower($languages[$squirrelmail_language]['DIR'])) {
...
if ('right_main.php' == $right_frame) {
    $urlMailbox = urlencode($mailbox);

    $right_frame_url = "webmail.php?mailbox=$urlMailbox&amp;sort=$sort&amp;startMessage=$startMessage";
} elseif ('options.php' == $right_frame) {
    $right_frame_url = 'options.php';
} elseif ('folders.php' == $right_frame) {
...
include 'left_main.php';
echo '</td><td>';

include $right_frame_url;
