 ...
 *
 * $Id: login.php,v 1.98 2003/04/01 14:59:05 jangliss Exp $
 */
...
function sqmail_login_is_done($name)
{
    $test_name = &$name;
    ...
    if (isset($HTTP_SESSION_VARS[$test_name]) || isset($_SESSION[$test_name])) {
        $result = true;
    }
...
if (sqmail_login_is_done('user_is_logged_in')) {
    require __DIR__ . '/webmail.php';
...
$custom_css = 'none';
//xoops
$xoops_module_header = displayHtmlHeader("$org_name - " . _('Login'), $header, false);
$onload = 'onload="squirrelmail_loginpage_onload();"';
...
$loginname_value = (sqgetGlobalVar('loginname', $loginname) ? htmlspecialchars($loginname, ENT_QUOTES | ENT_HTML5) : '');
...
echo html_tag(
    ...
    html_tag(
        ...
        html_tag(
            'td',
            '<center>' . //            ( isset($org_logo) && $org_logo
