 ...
 *
 * $Id: image.php,v 1.19 2003/03/03 05:44:34 ebullient Exp $
 */
if (!isset($xoopsIntro)) {
...
echo '</b></td></tr>' . "\n" . '<tr><td align=center><A HREF="' . $DownloadLink . '">' . _('Download this as a file') . '</A></B><BR>&nbsp;' . "\n" . '</TD></TR></TABLE>' . "\n" .

     '<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=2 ALIGN=CENTER>' . "\n" . '<TR><TD BGCOLOR="' . $color[4] . '">' . '<img src="' . $DownloadLink . '">' .
