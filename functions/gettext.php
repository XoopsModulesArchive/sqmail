 ...
 *   $sm_language, I think
 *
 * $Id: gettext.php,v 1.19 2002/12/31 12:49:31 kink Exp $
 */
...
function gettext_php_load_strings()
{
    ...
    $filename .= $squirrelmail_language . '/LC_MESSAGES/' . $gettext_php_domain . '.po';
...
function _($str)
{
    global $gettext_php_loaded, $gettext_php_translateStrings, $squirrelmail_language, $gettext_php_loaded_language, $gettext_php_short_circuit;
