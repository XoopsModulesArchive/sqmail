 ...
 * php versions.
 *
 * $Id: global.php,v 1.27 2003/03/13 10:13:17 pdontthink Exp $
 */
...
if (!check_php_version(4, 1)) {
    ...
    global $HTTP_COOKIE_VARS, $HTTP_ENV_VARS, $HTTP_POST_FILES, $_GET, $_POST, $HTTP_SERVER_VARS, $HTTP_SESSION_VARS, $PHP_SELF;
...
function sqgetGlobalVar($name, &$value, $search = SQ_INORDER)
{
    ...
    switch ($search) {
	   ...
	   all three arrays will be searched. */ default:
        case SQ_INORDER:
        case SQ_SESSION:
...
function sqsession_destroy()
{
    ...
    if (isset($_COOKIE[session_name()])) {
        setcookie(session_name(), '', time() - 5, $base_uri);
    }
