 ...
 *
 * $Id: display_messages.php,v 1.57 2003/03/10 23:23:08 kink Exp $
 */
...
function error_username_password_incorrect()
{
    ...
    $string = '<TR><TD ALIGN="center">' . _('Unknown user or password incorrect.') . '</TD></TR><TR><TD ALIGN="center">' . '<A HREF="' . sqm_baseuri() . '"login.php" TARGET=' . $frame_top . '>' . _('Click here to try again') . '</A>.' . '</TD></TR>';
...
function error_message($message, $mailbox, $sort, $startMessage, $color)
{
    ...
    $string = '<tr><td ALIGN="center">' . $message . '</td></tr>' . "\n" . '<tr><td ALIGN="center">' . '<A HREF="' . sqm_baseuri() . "src/right_main.php?sort=$sort&amp;startMessage=$startMessage" . "&amp;mailbox=$urlMailbox\">" . sprintf(_('Click here to return to %s'), $mailbox) . '</A></td></tr>';
